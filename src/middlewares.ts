  ...
  return app
    ...
    .use(
      swagger({
        ...
        documentation: {
          info: {
            title: "Kamiflix's API",
            description:
              "KamiFlix's API is a collection of APIs that provide data from various sources. Please noted that this API is still in beta that missing some of the routes, functions and may be subject to change in the future.",
            termsOfService: "https://docs.kamiflix.xyz/docs/api/usage",
            version: "3.0.0 Beta",
            contact: {
              name: "KamiFlix",
              url: "https://kamiflix.xyz",
              email: "kamiflix@gmail.com",
            },
            license: {
              name: "GPL-3.0",
              url: "https://github.com/kamiflix/api/blob/master/LICENSE",
            },
          },
          externalDocs: {
            url: "https://docs.kamiflix.xyz/docs/api/usage",
